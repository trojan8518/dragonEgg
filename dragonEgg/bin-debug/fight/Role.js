...
var Role = (function (_super) {
     ...
     * 创建血条
     */
    Role.prototype.createHpBar = function () {
        if (this._hpBar)
            return;
        this._hpBar = fairygui.UIPackage.createObject("main", "hpBar");
        if (this._r_scaleX > 0)
    ...
    Object.defineProperty(Role.prototype, "r_scaleX", {
        set: function (value) {
    ...
    Object.defineProperty(Role.prototype, "r_scaleY", {
        set: function (value) {
